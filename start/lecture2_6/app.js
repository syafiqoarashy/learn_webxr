...
class App{
    ...
    loadGLTF(){
        ...
        loader.load(
            ...
            function(gltf){
                ...
                const bbobx = new THREE.Box3().setFromObject(gltf.scene);
                console.log('min:${vec3ToString(bbox.min, 2)} - max:${vector3ToString(bbox.max, 2)}') 
    ...
    loadFBX(){
        ...
        loader.load(
            ...
            function(object){
                self.chair = object;
                const bbobx = new THREE.Box3().setFromObject(object);
                console.log('min:${vec3ToString(bbox.min, 2)} - max:${vector3ToString(bbox.max, 2)}') 
